...
`sidecar_template_full` a dictionary containing every field specified in the BIDS standard for PET imaging data
`sidecar_template_short` a dictionary containing only the required fields in the BIDS standard for PET imaging data
"""
